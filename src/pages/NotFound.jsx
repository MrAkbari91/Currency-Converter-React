    ...
    <section className="pagenotfound flex h-screen items-center p-16 dark:bg-gray-700 dark:text-gray-100">
      <div className="container mx-auto my-8 flex flex-col items-center justify-center px-5">
        <div className="max-w-md text-center">
          <div
            className={`mb-8 text-9xl font-extrabold text-gray-600 dark:text-gray-200`}
          >
          ...
          <p
            className={`text-3xl font-semibold text-gray-600 dark:text-gray-400`}
          >
            Sorry, we couldn't find this page.
          </p>
          <p className={`mt-4 mb-8 text-xl text-gray-600 dark:text-gray-200`}>
